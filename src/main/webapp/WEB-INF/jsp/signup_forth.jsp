            ...
            <ul style="top:1px ;left:0px" class="nav pull-right ">
                <li style="height:30px;" class="dropdown user">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="javascript:;">
                        <img width="29" height="25" style="width:25px;height:21px;" src="images/noimage.png" alt="profile image">
...
<div class="container PT20">
    <div class="row-fluid">
        <!---logo start here-->
        <div class="span6">
            <a href="/" class="pull-left"><img src="images/rimt-logo.png" alt="RIMT"></a>
        </div>
        <!--logo ends-->
    </div>
</div>
...
<div style="overflow:hidden;" class="container">
    <div id="wrapper">
        <div id="steps" style="width: 3510px; margin-left: 0px;">
            <fieldset class="step">
                <form class="formElem form-horizontal" >
                    <div class="row-fluid">
...
<div class="container">
    <div class="row-fluid text-center;">
        ...
        <div class=" span3 pull-right PB10 ML30 text-right">
            ...
            <a href="#" target="_blank"><img src="images/facebook-icon.png" width="33px" height="33px"></a>
            <a href="#" target="_blank"><img src="images/twitter-icon.png" width="33px" height="33px"></a>
            <a href="#" target="_blank"><img src="images/gplus-icon.png" width="33px" height="33px"></a>
            <a href="#" target="_blank"><img src="images/linkedin-icon.png" width="33px" height="33px"></a>
        </div>
    </div>
</div>
